    ...
    <header>
      ...
      <nav class="menu">
            <div class="logo">ELEVE</div>
            <a href="index.php?deco=1"> <button type=submit class="btn-deconnexion"> DECONNEXION </button> </a>
             <div class="menu-buttons">
                         ...
                         <button class="btn-menu" onclick="window.location.href='ccr.php'">Nouveau compte rendu</button>
            </div>
        </nav>
